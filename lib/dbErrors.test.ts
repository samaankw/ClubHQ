import { userFacingDbError } from "./dbErrors";
...
describe("userFacingDbError", () => {
  ...
  it("explains an impossible date", () => {
    expect(userFacingDbError('date/time field value out of range: "2026-13-45"', FALLBACK)).toBe("That date isn't a real calendar date.");
  });
