import { buildStartsAt, matchTimePreset, weeklyOccurrences, TIME_PRESETS } from "./eventSchedule";
...
describe("matchTimePreset", () => {
  it("matches an on-chip time", () => {
    expect(matchTimePreset("5", "00", "PM")).toEqual(expect.objectContaining({ label: "5:00 PM" }));
  });
