-- Recovered from the live database, not authored here.
--
-- This migration was applied directly to the ClubHQv1 project and never
-- committed, so the repo's history stopped at 0032 while production was at
-- 0033. Anyone cloning the repo and applying migrations got a schema without
-- org_type, teams.kind, or the extended events.type list -- a difference git
-- had no way to show. Recovered verbatim from
-- supabase_migrations.schema_migrations so the two histories agree again.
--
