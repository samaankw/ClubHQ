...
function UsageDonut({ manual, voice }: { manual: number; voice: number }) {
  ...
  return (
    <View style={[styles.donut, { width: diameter, height: diameter, borderRadius: r, backgroundColor: color.icon.brand }]}>
      <View style={[styles.donutHalf, { top: 0, left: r, width: r, height: diameter, backgroundColor: rightIsFull ? color.icon.success : color.icon.brand }]}>
        {!rightIsFull && theta > 0 && (
          <View
            style={[
              styles.donutWedge,
      ...
      <View
        style={[
          styles.donutHole,
          { width: holeD, height: holeD, borderRadius: holeD / 2, top: holeOffset, left: holeOffset },
        ]}
      />
    </View>
  );
              ...
              <View style={styles.usageRow}>
                ...
                <View style={styles.legend}>
                  <View style={styles.legendRow}>
                    ...
                    <Text role="h3" style={{ flex: 1 }}>Manual</Text>
                  ...
                  <View style={styles.legendRow}>
                    ...
                    <Text role="h3" style={{ flex: 1 }}>Voice</Text>
            ...
            <Card style={{ gap: space[2] }}>
              ...
              <View style={{ gap: space[2] }}>
                {WATCH_ITEMS.map((item) => (
                  <Text key={item} tone="secondary" role="bodySm">• {item}</Text>
                ))}
              </View>
            </Card>
          </>
